...
public class CategorieDAOImpl implements CategorieDAO{
    ...
    public Categorie afficherCategorieArticle(long idArticle) {
        String sql = "select libelle,categorie.idCategorie from categorie Inner Join article ON categorie.idCategorie = article.idCategorie where idArticle = :idArticle";
        MapSqlParameterSource paramSource = new MapSqlParameterSource();
